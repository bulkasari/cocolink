...
export const EPISODE = [
  ...
  { type: 'video', id: 'C4_DoctorGreet', file: 'C4_DoctorGreet.mp4', section: '🌟 3단계 · 내가 직접 체험하기', subLabel: '의사 선생님 인사', hudActive: 3, skip: false, afterEnd: 'choice-c5-route', action: eventMap['C4_DoctorGreet']?.action },
